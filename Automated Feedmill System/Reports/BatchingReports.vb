...
Public Class BatchingReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automated_Feedmill_System.BatchingReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBatchingReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BatchingReports = New BatchingReports()
        rpt.Site = Me.Site
        Return rpt
    End Function
