...
Public Class PerBatchReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Automated_Feedmill_System.PerBatchReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPerBatchReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PerBatchReport = New PerBatchReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
